...
2. **Status:** Lies `docs/project/ROADMAP_MVP_PRODUCTION.md`
   - Was ist fertig? (v0.12.2)
...
### 2. docs/project/ROADMAP_MVP_PRODUCTION.md
- [ ] "Verfügbare Features" Sektion aktualisieren
- [ ] Feature-Matrix aktualisieren (falls nötig)
...
- ✅ docs/project/ROADMAP_MVP_PRODUCTION.md (Status aktualisiert)
