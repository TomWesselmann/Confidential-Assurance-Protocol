...
export const VerificationView: React.FC = () => {
  ...
  const { status, bundleId, manifestHash, proofHash, signatureValid, timestampValid, details } = verificationResult;
      ...
      {details?.statement_validation && details.statement_validation.length > 0 && (
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
          ...
          <div className="divide-y divide-gray-100 dark:divide-gray-700">
            {details.statement_validation.map((check: { field: string; status: 'ok' | 'mismatch' }, idx: number) => (
