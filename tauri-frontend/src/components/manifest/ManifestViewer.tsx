...
// Section component extracted outside to avoid re-creation on each render
...
const Section: React.FC<SectionProps> = ({ id, title, children, isExpanded, onToggle }) => {
  return (
...
export const ManifestViewer: React.FC<ManifestViewerProps> = ({ manifest }) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6 space-y-4">
      ...
      {/* Overview Section */}
      <Section id="overview" title="Overview" isExpanded={expandedSections.has('overview')} onToggle={toggleSection}>
      ...
      {/* Policy Section */}
      <Section id="policy" title="Policy" isExpanded={expandedSections.has('policy')} onToggle={toggleSection}>
        <div className="space-y-2">
          <div className="flex items-center justify-between py-2">
      ...
      {/* Proof Section */}
      <Section id="proof" title="Proof" isExpanded={expandedSections.has('proof')} onToggle={toggleSection}>
        <div className="space-y-2">
          <div className="flex items-center justify-between py-2">
      ...
      {/* Audit Trail Section */}
      <Section id="audit" title="Audit Trail" isExpanded={expandedSections.has('audit')} onToggle={toggleSection}>
      ...
      {manifest.signatures.length > 0 && (
        <Section id="signatures" title={`Signatures (${manifest.signatures.length})`} isExpanded={expandedSections.has('signatures')} onToggle={toggleSection}>
          <div className="space-y-4">
      ...
      {manifest.time_anchor && (
        <Section id="timeanchor" title="Time Anchor (Blockchain)" isExpanded={expandedSections.has('timeanchor')} onToggle={toggleSection}>
          <div className="space-y-2">
            <div className="flex items-center justify-between py-2">
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                Blockchain:
