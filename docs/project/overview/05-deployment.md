...
>
> Diese Dokumentation beschreibt das Deployment der reduzierten "Minimal Local Agent"-Variante.
>
> **Verfügbar:** ✅ Desktop App (mit integrierter WebUI), ✅ Binary, ✅ Docker, ✅ REST API (Verifier)
>
> **Entfernt:** ❌ PKCS#11/HSM, ❌ CloudKMS, ❌ ZK-Backends, ❌ Sanctions Lists, ❌ Standalone WebUI
>
> Die Schlüsselverwaltung erfolgt dateibasiert (Ed25519). Für HSM- oder Cloud-KMS-Integration ist eine spätere Production-Version erforderlich.
...
1. **Desktop App (Tauri)** - Native App für Windows/macOS/Linux (offline, v0.12.2)
...
## 1. Desktop App Deployment (Tauri 2.0) - v0.12.2

> ⭐ **Empfohlen:** Native Desktop-Anwendung für komplett offline Compliance-Workflow mit integrierter WebUI
...
## 2.5 cap-bundle.v1 Package Format (Deployment Considerations) ⭐
...
### Debugging cap-bundle.v1 Issues

**Problem: _meta.json missing**
...
- ✅ **Desktop App** für Offline-Nutzung ohne Server (v0.12.2, mit integrierter WebUI)
- ✅ Binary + Systemd für einfache Server-Deployments
- ✅ Docker für Container-basierte Deployments
- ✅ Kubernetes für Enterprise-Skalierung
- ❌ ~~WebUI für Browser-basierte Verifikation~~ → in Desktop App integriert (ab v0.12.0)
