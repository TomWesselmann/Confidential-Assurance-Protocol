...
>
> **Verfügbar:** ✅ REST API (Verifier), ✅ CLI, ✅ Mock Backend, ✅ Ed25519 (dateibasiert), ✅ Desktop App (Tauri)
>
...
| `backend` | string | Yes | Proof backend: "mock" (nur mock in Minimal Local Agent) |
...
**Integration:** Wird primär vom Desktop App verwendet (`tauri-frontend/src/core/api/client.ts:uploadProofPackage()`)
...
- `eq` - Equality-Check
- `non_membership` - Blacklist-Check (⚠️ Sanctions Lists entfernt in Minimal Local Agent)
...
**Backends:**
- `mock` - Mock proof (einziges verfügbares Backend)
...
| `backend` | string | Proof backend: "mock" (nur mock in Minimal Local Agent) |
