...
>
> Diese Version ist eine reduzierte "Minimal Local Agent"-Variante für lokale Entwicklung und Proof-of-Concept.
>
> **Aktuelle Implementierung:**
> - ✅ Mock Backend (SimplifiedZK)
> - ✅ Ed25519 Signaturen (dateibasiert)
> - ✅ REST API + CLI + Desktop App (Tauri 2.0 mit integrierter WebUI)
> - ✅ SQLite/JSON Registry
>
> **Entfernte Features (für zukünftige Production-Version):**
> - ❌ PKCS#11/HSM
> - ❌ CloudKMS
> - ❌ ZK-Backends (zkvm, halo2, spartan)
> - ❌ Sanctions Lists
> - ❌ Standalone WebUI (ab v0.12.0 in Desktop App integriert)
>
> **Roadmap-Hinweis:** Die unten aufgeführten Roadmap-Items zu Halo2, ZK-Backends und HSM sind für eine zukünftige Production-Version geplant und derzeit nicht in der Minimal Local Agent Version enthalten.

## 📖 Über dieses Kapitel

Dieses Kapitel zeigt Ihnen:
- **Was bereits fertig ist** (v0.12.2 - Aktueller Stand als Minimal Local Agent)
- **Was für zukünftige Versionen geplant ist** (Production-Version mit ZK, HSM)
...
- Integrierte Web-Oberfläche in Desktop App (standalone WebUI entfernt)

🔄 **Minimal Local Agent Status:**
- Mock Backend (SimplifiedZK) für Proof-of-Concept
- SAP-Integration (Grundstruktur vorhanden)

> ⚠️ **Hinweis:** In der Minimal Local Agent Version wurde auf echte ZK-Backends (Halo2, zkvm, spartan) verzichtet. Diese sind für eine zukünftige Production-Version geplant.

### Was kommt als Nächstes? (Zukünftige Production-Version)

**Production v1.0** (geplant für spätere Entwicklungsphase)

Geplante Features für die Production-Version:
- ⏳ Echte kryptographische Beweise erstellen (Halo2) - *derzeit entfernt*
...
| Feature | Heute (v0.12.2) | Bis Jahresende (v1.0) |
|---------|-----------------|----------------------|
| Nachweise erstellen | ✅ Ja (vereinfacht) | ✅ Ja (vollständig) |
| SAP-Anbindung | ⏳ Vorbereitet | ✅ Funktionsfähig |
| Web-Oberfläche | ✅ In Desktop App integriert | ✅ Ja (Advanced) |
| **Desktop App** | ✅ **Ja (Offline + WebUI)** | ✅ Ja (erweitert) |
| Security-Prüfung | 🔄 Intern | ✅ Extern geprüft |
| Einsatzbereit | ✅ Tests + Desktop | ✅ Produktion |

---

## ✅ Aktueller Status (v0.12.2) - Was ist FERTIG
...
### Week 4: WebUI Integration ✅ (Abgeschlossen) → ❌ ENTFERNT in v0.12.0

> ⚠️ **ENTFERNT in v0.12.0:** Die standalone HTTP-basierte WebUI wurde entfernt.
>
> **Ersetzt durch:** Tauri Desktop App mit integrierter React WebUI (siehe [Week 8](#week-8-desktop-app-tauri-20---neu-in-v0120)).
>
> Die folgende Dokumentation ist historisch und wird nur zu Referenzzwecken aufbewahrt.

<details>
<summary>📚 Historische Referenz (v0.11.0) - Nicht mehr aktuell</summary>
...
- [x] **Axios** - HTTP client für API-Kommunikation ❌ Entfernt
...
3. **Policy Auto-Extraction:**
   ...
   - Backend-Typ (mock) wird gespeichert
...
### Week 8: Desktop App (Tauri 2.0) ✅ (Abgeschlossen) - v0.12.2
...
## 🎯 Roadmap für zukünftige Production-Version

> ⚠️ **Hinweis:** Die folgenden Roadmap-Items sind für eine zukünftige Production-Version geplant.
> In der aktuellen Minimal Local Agent Version (v0.12.2) sind ZK-Backends und HSM-Integration entfernt.

### Woche 1-2: Halo2 ZK-Proofs (⏳ Zukünftig)

**Ziel:** Echte Zero-Knowledge-Beweise statt SimplifiedZK Mock

> ⚠️ **Status in Minimal Local Agent:** ENTFERNT - Nur Mock Backend verfügbar
...
## 📊 Feature-Vergleich: Minimal Local Agent vs. Zukünftige Versionen

> ⚠️ **Hinweis:** v0.12.2 ist die "Minimal Local Agent" Version. Halo2 und HSM sind für zukünftige Production-Versionen geplant.

| Feature | v0.12.2 (Minimal Local Agent) | Production (Zukünftig) | v2.0 (Zukünftig) |
|---------|-------------------------------|------------------------|------------------|
| **Nachweise** |
| Proof Generation | ✅ Mock (SimplifiedZK) | ⏳ Halo2 (geplant) | ⏳ Multi-Backend |
| Proof Verification | ✅ | ✅ | ✅ |
...
| CLI | ✅ | ✅ | ✅ |
| REST API | ✅ | ✅ | ✅ GraphQL |
| Web UI | ❌ Standalone entfernt (in Desktop App integriert) | ✅ **Advanced** | ✅ **Enterprise** |
| **Desktop App** | ✅ **Tauri 2.0 mit integrierter WebUI** | ✅ Auto-Updates | ✅ Multi-Platform |
| Mobile App | ❌ | ❌ | 📅 Geplant |
| **Integration** |
| CSV Import | ✅ | ✅ | ✅ |
...
| HSM Support | ❌ **ENTFERNT** | ⏳ PKCS#11 (geplant) | ✅ |
| **Betrieb** |
...
**Hardware Security Module (HSM)** ⚠️ *Zukünftig*
> **Status in Minimal Local Agent:** ENTFERNT - Nur dateibasierte Ed25519-Schlüssel

Geplant für Production-Version:
- PKCS#11 Provider
...
|--------|-------------------|--------|------------|
| Halo2 zu komplex | Mittel | Hoch | Claude Code Erfahrung, MockZK als Fallback bis Production |
...
**Version:** 1.2 (mit Desktop App v0.12.2, Standalone WebUI entfernt)
