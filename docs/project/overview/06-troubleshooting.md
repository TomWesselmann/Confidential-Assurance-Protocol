...
>
> Diese Dokumentation bezieht sich auf die "Minimal Local Agent"-Variante.
>
> **Verfügbar:** ✅ Mock Backend, ✅ Ed25519 (dateibasiert), ✅ REST API, ✅ CLI, ✅ Desktop App (Tauri)
>
> **Entfernt:** ❌ PKCS#11/HSM, ❌ CloudKMS, ❌ ZK-Backends (zkvm, halo2, spartan), ❌ Sanctions Lists, ❌ Standalone WebUI
>
> Troubleshooting-Einträge zu entfernten Features sind hier der Vollständigkeit halber dokumentiert, aber nicht relevant für diese Version.
...
### 12. Monitoring Stack Issues (Week 2)
...
### 14. cap-bundle.v1 Package Errors ⭐
...
# ⚠️ In Minimal Local Agent ist nur "mock" verfügbar
# (zkvm, halo2, spartan wurden entfernt)
# Lösung: Backend muss "mock" sein
...
### 15. Desktop App Errors (Tauri 2.0) - v0.12.2

> ⭐ **Desktop App (Tauri 2.0):** Troubleshooting für die Desktop App (seit v0.12.0, aktuell v0.12.2)
...
# → CSS prüfen in tauri-frontend/src/App.tauri.tsx
...
**A:** Aktuell (v0.12.2 - Minimal Local Agent):
- **Mock** - Einziges verfügbares Backend

> ⚠️ **ENTFERNT in Minimal Local Agent:**
> - ~~ZK-VM~~ (wurde entfernt)
> - ~~Halo2~~ (wurde entfernt)
> - ~~Spartan~~ (wurde entfernt)
...
### Q11: Wie funktioniert die Desktop App offline? (v0.12.2)
...
### Q12: Kann ich Desktop App und Verifier API parallel nutzen?

**A:** Ja, beide Systeme sind kompatibel:
- **Desktop App:** Arbeitet vollständig offline mit lokalen Projekt-Ordnern
- **Verifier API:** Server-basierte Verifikation für Enterprise-Szenarien
- **Bundle-Kompatibilität:** Desktop-Export (cap-bundle.v1) → Server-Verifikation über API
