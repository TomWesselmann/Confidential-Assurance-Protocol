...
**Version:** 0.12.2 – **Minimal Local Agent**
**Für:** Einsteiger und Fortgeschrittene
**Datum:** 2025-12-14

> 📌 **Minimal Local Agent Version**
>
...
13. [WebUI Anleitung](#webui-anleitung) ❌ ENTFERNT (ab v0.12.0, in Desktop App integriert)
...
**Hinweis:** Für einfache Nutzung empfehlen wir die **Desktop App** (siehe unten). Das CLI ist ebenfalls gut für lokale Workflows.
...
### Alternative: Mit WebUI ❌ ENTFERNT (ab v0.12.0)

> ⚠️ **ENTFERNT:** Die standalone WebUI wurde in v0.12.0 entfernt und ist jetzt in die Desktop App integriert.
> Verwende stattdessen die **Desktop App** (siehe oben) oder das **CLI** für alle Operationen.
...
## 🖥️ Desktop App (v0.12.2)

> ⭐ **Empfohlen für Einzelpersonen und Freelancer!** Die Desktop App funktioniert komplett offline - kein Server, keine Kommandozeile nötig. Enthält integrierte WebUI.
...
- **Integrierte WebUI:** React-basierte Oberfläche (ersetzt die standalone WebUI ab v0.12.0)

### Vorteile gegenüber CLI

| Aspekt | Desktop App | CLI |
|--------|-------------|-----|
| **Offline** | ✅ Vollständig | ✅ |
| **Benutzerfreundlich** | ✅ Grafisch | ⚠️ Terminal nötig |
| **Installation** | ✅ 1 Datei | ⚠️ Rust + Build |
| **Daten bleiben lokal** | ✅ | ✅ |
| **Integrierte WebUI** | ✅ | ❌ |

> **Hinweis:** Die standalone WebUI wurde in v0.12.0 entfernt. Die WebUI ist jetzt in die Desktop App integriert.
...
Wenn mehrere Leute **remote** auf deine API zugreifen sollen (z.B. Auditoren). **Für Einzelpersonen empfehlen wir die Desktop App!**

**Warum ist das wichtig?**
Der Server bietet eine REST API für entfernte Clients und Enterprise-Integration (z.B. SAP).

**Wann nutze ich das?**
- Du willst anderen Leuten Zugriff geben (z.B. Auditor soll Proofs hochladen)
- Du testest Remote-Szenarien
- Du integrierst mit anderen Systemen (SAP, CI/CD)
...
- ⚠️ HSM-Unterstützung in Minimal Local Agent entfernt (für zukünftige Production-Version geplant)
...
- Token notieren - brauchst du für API-Zugriffe (z.B. curl, Client-Integration)
...
- `proof_units`: Array von ProofUnit-Objekten
  ...
  - `backend`: ZK-Backend ("mock" in Minimal Local Agent; zkvm/halo2 für Production geplant)
...
- Am besten: Verschlüsselter USB-Stick (HSM-Unterstützung für zukünftige Production-Version geplant)
...
## 🌐 WebUI Anleitung ❌ ENTFERNT (ab v0.12.0)

> ⚠️ **ENTFERNT in v0.12.0:** Die standalone HTTP-basierte WebUI wurde entfernt.
>
> **Ersetzt durch:** Tauri Desktop App mit integrierter React WebUI.
> Siehe [Desktop App (v0.12.2)](#-desktop-app-v0122) für aktuelle Anweisungen.
>
...
**Terminal 1 - API Server (optional, für Remote-Zugriff):**
```bash
cd agent
...
**Terminal 2 - Proof erstellen (komplett):**
```bash
cd agent && \
...
**Dann:** Desktop App starten → Verifier Mode → Package hochladen. Oder: Package an Auditor senden.
