...
18. [Desktop-App & Tauri](#18-desktop-app--tauri) (15 Begriffe)
19. [Enterprise Security & Compliance](#19-enterprise-security--compliance) (25 Begriffe) ✨ NEU

**Gesamt: 237+ Begriffe** (Stand: v0.12.0)
...
## 19. Enterprise Security & Compliance

### OWASP Top 10 ⭐ ✨ NEU v0.12.0
**Einfach:** Die 10 häufigsten Sicherheitsrisiken für Webanwendungen (Standard der Branche).

**Technisch:** Industry-standard awareness document published by OWASP (Open Web Application Security Project) listing most critical security risks.

**OWASP Top 10 (2021):**
1. **A01 - Broken Access Control** - Zugriffskontrollen versagen
2. **A02 - Cryptographic Failures** - Schwache Kryptografie
3. **A03 - Injection** - SQL, NoSQL, Command Injection
4. **A04 - Insecure Design** - Fehlende Security-by-Design
5. **A05 - Security Misconfiguration** - Fehlkonfigurationen
6. **A06 - Vulnerable Components** - Veraltete Dependencies
7. **A07 - Authentication Failures** - Schwache Authentifizierung
8. **A08 - Data Integrity Failures** - Software-Integrität
9. **A09 - Security Logging Failures** - Unzureichendes Logging
10. **A10 - Server-Side Request Forgery** - SSRF-Angriffe

**Im Projekt:** Security Audit analysiert alle 10 Kategorien (57% Enterprise Score).

**Verwandte Begriffe:** [Security Audit](#security-audit), [SOC 2](#soc-2-type-ii), [ISO 27001](#iso-27001)

---

### Security Audit ⭐ ✨ NEU v0.12.0
**Einfach:** Umfassende Sicherheitsüberprüfung eines Systems durch Experten.

**Technisch:** Systematic evaluation of security controls, policies, and procedures including code review, penetration testing, and compliance assessment.

**Audit-Typen:**
- **White-Box:** Vollständiger Quellcode-Zugriff
- **Black-Box:** Nur Angreifer-Perspektive
- **Gray-Box:** Kombiniert (z.B. mit Dokumentation)

**Im Projekt:** Enterprise Security Audit durchgeführt (02.12.2025)
- **Scope:** 547 Crates, 12 kritische Dateien
- **Ergebnis:** 57% Enterprise Readiness
- **Findings:** 12 (4 Critical, 4 High, 3 Medium, 1 Low)
- **Report:** `/docs/security/SECURITY_AUDIT_REPORT.md`

**Verwandte Begriffe:** [OWASP Top 10](#owasp-top-10), [Enterprise Readiness Score](#enterprise-readiness-score)

---

### Enterprise Readiness Score ⭐ ✨ NEU v0.12.0
**Einfach:** Bewertung wie bereit ein System für Enterprise-Einsatz ist (0-100%).

**Technisch:** Composite score measuring system maturity across security, operations, observability, resilience, and compliance dimensions.
...
**Im Projekt:**
- **Aktuell:** 57% (DEV-READY)
- **Ziel Phase 4:** 95%+ (ENTERPRISE-READY)

**Klassifikation:**
- **< 50%:** Development Only
- **50-70%:** Test/Staging Ready
- **70-85%:** Production Ready (Basic)
- **85-95%:** Enterprise Ready
- **> 95%:** Enterprise Premium

**Verwandte Begriffe:** [Security Audit](#security-audit), [SOC 2](#soc-2-type-ii)

---

### CORS (Cross-Origin Resource Sharing) ⭐ ✨ NEU v0.12.0
**Einfach:** Mechanismus, der bestimmt, welche Websites auf Ihre API zugreifen dürfen.

**Technisch:** HTTP-header based mechanism allowing a server to indicate origins (domain, scheme, port) other than its own from which a browser should permit loading resources.
...
**Security Issue im Projekt (F-001):**
```rust
// ❌ UNSICHER (aktuell)
.allow_origin(Any)
...
**Status:** Kritisches Finding, Fix in Phase 1 geplant

**Verwandte Begriffe:** [Security Headers](#security-headers), [Preflight Request](#preflight-request)

---

### Security Headers ✨ NEU v0.12.0
**Einfach:** HTTP-Header, die Browser anweisen, wie sie Ihre Website schützen sollen.

**Technisch:** HTTP response headers instructing browsers to enable security features preventing attacks like XSS, clickjacking, and MIME sniffing.
...
| `Referrer-Policy` | Kontrolle über Referrer |
| `Permissions-Policy` | Feature-Berechtigungen |

**Security Issue im Projekt (F-002):**
- Alle Security Headers fehlen aktuell
- Fix: SecurityHeadersMiddleware in Phase 1

**Verwandte Begriffe:** [CORS](#cors-cross-origin-resource-sharing), [HSTS](#hsts)

---

### HSTS (HTTP Strict Transport Security) ✨ NEU v0.12.0
**Einfach:** Header, der Browser zwingt, nur HTTPS zu verwenden.

**Technisch:** HTTP header instructing browsers to only connect to server using HTTPS for specified time period, preventing protocol downgrade attacks.
...
- `preload`: Browser-Preload-Liste Registrierung

**Im Projekt:** Phase 1 Implementation geplant

**Verwandte Begriffe:** [Security Headers](#security-headers), [TLS](#tls-transport-layer-security)

---

### CSP (Content Security Policy) ✨ NEU v0.12.0
**Einfach:** Regel, die bestimmt, von wo Scripts und Ressourcen geladen werden dürfen.

**Technisch:** HTTP header defining approved sources of content that browser may load, preventing XSS and data injection attacks.
...
**Direktiven:**
- `default-src`: Fallback für alle Ressourcen
- `script-src`: JavaScript-Quellen
- `style-src`: CSS-Quellen
- `img-src`: Bild-Quellen
- `connect-src`: AJAX/WebSocket-Ziele

**Im Projekt:** Phase 1 Implementation geplant

**Verwandte Begriffe:** [Security Headers](#security-headers), [XSS](#xss-cross-site-scripting)

---

### XSS (Cross-Site Scripting) ✨ NEU v0.12.0
**Einfach:** Angriff, bei dem bösartiger JavaScript-Code in Websites eingeschleust wird.

**Technisch:** Security vulnerability allowing attackers to inject client-side scripts into web pages viewed by other users.

**XSS-Typen:**
- **Reflected XSS:** Script in URL-Parameter
- **Stored XSS:** Script in Datenbank gespeichert
- **DOM-based XSS:** Client-seitige DOM-Manipulation
...
**Im Projekt:** OWASP A03 - Durch CSP in Phase 1 adressiert

**Verwandte Begriffe:** [CSP](#csp-content-security-policy), [OWASP Top 10](#owasp-top-10)

---

### JWKS (JSON Web Key Set) ✨ NEU v0.12.0
**Einfach:** Standard-Format für öffentliche Schlüssel zur JWT-Validierung.

**Technisch:** JSON-formatted set of keys containing public keys for verifying JWT signatures. Allows key rotation without code changes.
...
- Standard OAuth2/OIDC Kompatibilität

**Security Issue im Projekt (F-003):**
- Aktuell: Hardcoded RSA-Keys im Code
- Fix: JWKS Endpoint Support in Phase 2

**Verwandte Begriffe:** [JWT](#jwt-json-web-token), [OAuth2](#oauth2), [Key Rotation](#key-rotation)

---

### SOC 2 Type II ⭐ ✨ NEU v0.12.0
**Einfach:** Audit-Zertifizierung für Cloud-Services (beweist Sicherheit über Zeit).

**Technisch:** Service Organization Control 2 Type II audit examining security, availability, processing integrity, confidentiality, and privacy controls over time (typically 6-12 months).

**Trust Service Criteria:**
1. **Security:** Schutz gegen unbefugten Zugriff
2. **Availability:** System ist verfügbar wie vereinbart
3. **Processing Integrity:** Verarbeitung vollständig und akkurat
4. **Confidentiality:** Daten bleiben vertraulich
5. **Privacy:** PII wird gemäß Richtlinien verarbeitet

**Im Projekt:**
- **Aktueller Score:** 40% (CC1-CC5 teilweise erfüllt)
- **Ziel Phase 4:** 90%+ Compliance

**Verwandte Begriffe:** [ISO 27001](#iso-27001), [Enterprise Readiness Score](#enterprise-readiness-score)

---

### ISO 27001 ⭐ ✨ NEU v0.12.0
**Einfach:** Internationaler Standard für Informationssicherheits-Management.

**Technisch:** International standard for Information Security Management Systems (ISMS), providing framework for policies and procedures including legal, physical, and technical controls.

**Annex A Kontrollen (Auswahl):**
- A.5: Policies
- A.6: Organisation
...
**Im Projekt:**
- **Aktueller Score:** 50% (Kontrollen teilweise implementiert)
- **Ziel Phase 4:** 85%+ für Zertifizierung

**Verwandte Begriffe:** [SOC 2](#soc-2-type-ii), [Security Audit](#security-audit)

---

### Graceful Shutdown ✨ NEU v0.12.0
**Einfach:** Sauberes Herunterfahren eines Services ohne Datenverlust.

**Technisch:** Controlled termination process handling SIGTERM signal, completing in-flight requests, closing connections properly, and releasing resources.
...
// Warte auf in-flight requests (max 30s)
// Schließe DB-Verbindungen
// Beende Hintergrund-Tasks
```

**Phasen:**
1. **Signal empfangen:** SIGTERM/SIGINT
2. **Stop accepting:** Keine neuen Requests
3. **Drain connections:** Bestehende Requests abschließen
4. **Cleanup:** Ressourcen freigeben
5. **Exit:** Prozess beenden

**Im Projekt:** Phase 1 Implementation (4h Aufwand)

**Verwandte Begriffe:** [SIGTERM](#sigterm), [Health Check](#health-check)

---

### SIGTERM ✨ NEU v0.12.0
**Einfach:** Unix-Signal zum sauberen Beenden eines Prozesses.

**Technisch:** Termination signal (15) sent by orchestrators like Kubernetes to gracefully stop processes before forceful SIGKILL.

**Kubernetes Shutdown-Sequenz:**
1. **preStop Hook** (optional)
2. **SIGTERM** gesendet
3. **Grace Period** (default 30s)
4. **SIGKILL** (erzwungen)

**Im Projekt:** Graceful Shutdown Handler für Kubernetes-Kompatibilität

**Verwandte Begriffe:** [Graceful Shutdown](#graceful-shutdown), [Kubernetes](#kubernetes-k8s)

---

### Security Finding ✨ NEU v0.12.0
**Einfach:** Identifiziertes Sicherheitsproblem aus einem Audit.

**Technisch:** Documented security vulnerability or misconfiguration discovered during audit, classified by severity and containing remediation guidance.

**Severity-Klassifikation:**
| Severity | CVSS | Response Time |
|----------|------|---------------|
| Critical | 9.0-10.0 | 24-48h |
| High | 7.0-8.9 | 1-2 Wochen |
| Medium | 4.0-6.9 | 1-3 Monate |
| Low | 0.1-3.9 | Bei nächstem Release |

**Im Projekt (Findings aus Audit):**
- **F-001:** CORS Allow-All (CRITICAL)
- **F-002:** Missing Security Headers (CRITICAL)
- **F-003:** Hardcoded Mock Keys (CRITICAL)
- **F-004:** Dev Token Bypass (HIGH)

**Verwandte Begriffe:** [Security Audit](#security-audit), [OWASP Top 10](#owasp-top-10)

---

### Module Security Score ✨ NEU v0.12.0
**Einfach:** Sicherheitsbewertung für einzelne Code-Module (0-100%).

**Technisch:** Component-level security rating based on code review, vulnerability analysis, and best practice compliance.
...
**Im Projekt (Module Scores):**
| Modul | Score | Status |
|-------|-------|--------|
| `crypto/mod.rs` | 95% | Exzellent |
| `api/upload.rs` | 90% | Exzellent |
| `api/tls.rs` | 85% | Gut |
| `api/verify.rs` | 80% | Gut |
| `api/auth.rs` | 55% | Kritisch |

**Verwandte Begriffe:** [Security Audit](#security-audit), [Enterprise Readiness Score](#enterprise-readiness-score)

---

### Penetration Test (Pentest) ✨ NEU v0.12.0
**Einfach:** Simulierter Hacker-Angriff zum Testen der Sicherheit.

**Technisch:** Authorized simulated attack on computer system to evaluate security of systems and identify vulnerabilities.

**Pentest-Phasen:**
1. **Reconnaissance:** Informationen sammeln
2. **Scanning:** Schwachstellen identifizieren
3. **Exploitation:** Schwachstellen ausnutzen
4. **Post-Exploitation:** Zugriff ausweiten
5. **Reporting:** Dokumentation

**Im Projekt:**
- Phase 2 Exit Criteria: No Critical/High Findings
- Externer Pentest geplant für Enterprise-Zertifizierung

**Verwandte Begriffe:** [Security Audit](#security-audit), [Security Finding](#security-finding)

---

### SBOM (Software Bill of Materials) ✨ NEU v0.12.0
**Einfach:** Vollständige Liste aller Software-Komponenten und Abhängigkeiten.

**Technisch:** Machine-readable inventory of software components and dependencies, enabling vulnerability tracking and license compliance.
...
**Im Projekt:** Phase 4 - CycloneDX SBOM Generation (4h Aufwand)

**Verwandte Begriffe:** [cargo audit](#cargo-audit), [Dependency](#dependency)

---

### cargo audit ✨ NEU v0.12.0
**Einfach:** Tool zum Prüfen von Rust-Dependencies auf bekannte Schwachstellen.

**Technisch:** Rust security advisory database tool scanning Cargo.lock for crates with known vulnerabilities (RustSec advisories).
...
- 2 bekannte Advisories (dev-dependencies only)
...
**Verwandte Begriffe:** [SBOM](#sbom-software-bill-of-materials), [Dependency](#dependency)

---

### Circuit Breaker ✨ NEU v0.12.0
**Einfach:** Schutzschalter, der fehlerhafte Services temporär abschaltet.

**Technisch:** Stability pattern preventing cascading failures by detecting failures and temporarily stopping calls to failing service.

**Zustände:**
1. **Closed:** Normal operation, requests pass through
2. **Open:** Failures threshold exceeded, requests fail fast
...
**Im Projekt:** Phase 3 Implementation (8h Aufwand)

**Verwandte Begriffe:** [Resilience](#resilience), [High Availability](#high-availability)

---

### OpenTelemetry (OTel) ✨ NEU v0.12.0
**Einfach:** Standard für Traces, Metrics und Logs in verteilten Systemen.

**Technisch:** Vendor-neutral observability framework providing APIs, SDKs, and tools for instrumentation, collection, and export of telemetry data.
...
**Im Projekt:** Phase 3 Integration (24h Aufwand)
- Integration mit Jaeger für Traces
- Prometheus Export für Metrics

**Verwandte Begriffe:** [Jaeger](#jaeger), [Prometheus](#prometheus), [Distributed Tracing](#distributed-tracing)

---

### Key Rotation ✨ NEU v0.12.0
**Einfach:** Regelmäßiger Wechsel von Kryptographie-Schlüsseln.

**Technisch:** Security practice of periodically changing cryptographic keys to limit exposure time if key is compromised.

**Best Practices:**
- Automatische Rotation (JWKS)
- Overlap-Periode für beide Keys
- Audit-Log für Rotation Events
- Backup vor Rotation

**Im Projekt:**
- KID-System für Key-Tracking (v0.10)
- JWKS Support geplant (Phase 2)
- Key Attestation Chain-of-Trust

**Verwandte Begriffe:** [JWKS](#jwks-json-web-key-set), [KID](#kid-key-id)

---

### SQLCipher ✨ NEU v0.12.0
**Einfach:** Verschlüsselung für SQLite-Datenbanken.

**Technisch:** Open source extension to SQLite providing transparent 256-bit AES encryption of database files.
...
**Im Projekt:** Phase 4 - Encryption at Rest (16h Aufwand)
- Policy Store Encryption
- Registry Encryption

**Verwandte Begriffe:** [Encryption](#encryption), [SQLite](#sqlite)

---

### Fuzzing ✨ NEU v0.12.0
**Einfach:** Automatisches Testen mit zufälligen/ungültigen Eingaben.

**Technisch:** Automated software testing technique providing random or malformed data as input to find security vulnerabilities and crashes.

**Fuzzing-Typen:**
- **Mutation-based:** Modifiziert gültige Inputs
- **Generation-based:** Generiert Inputs nach Grammatik
- **Coverage-guided:** Optimiert für Code-Abdeckung
...
**Im Projekt:** Phase 4 - Fuzzing Test Suite (16h Aufwand)
- JSON Parser Fuzzing
- Bundle Format Fuzzing
- API Input Fuzzing

**Verwandte Begriffe:** [Security Audit](#security-audit), [Penetration Test](#penetration-test-pentest)

---

### RFC 3161 Timestamp ✨ NEU v0.12.0
**Einfach:** Standardisierter Zeitstempel von vertrauenswürdiger Stelle.

**Technisch:** Internet X.509 Public Key Infrastructure Time-Stamp Protocol providing evidence that data existed at specific time.

**Workflow:**
1. Client berechnet Hash der Daten
2. Client sendet Hash an TSA
3. TSA signiert Hash + Timestamp
4. Client erhält Timestamp Token

**Im Projekt:** Phase 4 - RFC 3161 Verification (24h Aufwand)
- Integration mit externen TSAs
- Timestamp-Validierung in Verifier

**Verwandte Begriffe:** [Timestamp](#timestamp), [PKI](#pki)

---

**Ende des Glossars**

*Version: 2.3* (aktualisiert mit Enterprise Security & Compliance)
*Letzte Aktualisierung: 4. Dezember 2025*
*Projekt: LsKG-Agent v0.12.0*

**Changelog v2.3:**
- ✨ **NEU:** Kategorie 19: Enterprise Security & Compliance (25 Begriffe)
- ✨ OWASP Top 10, Security Audit, Enterprise Readiness Score
- ✨ CORS, Security Headers, HSTS, CSP, XSS
- ✨ JWKS, SOC 2 Type II, ISO 27001
- ✨ Graceful Shutdown, SIGTERM, Security Finding, Module Security Score
- ✨ Penetration Test, SBOM, cargo audit, Circuit Breaker
- ✨ OpenTelemetry, Key Rotation, SQLCipher, Fuzzing, RFC 3161 Timestamp
- 📊 Gesamt: 237+ Begriffe (+ 25 neue Begriffe seit v2.2)
