 ...
 *
 * @description Visual navigation for the 6-step Proofer workflow
 */
...
export const WorkflowStepper: React.FC = () => {
  ...
  return (
    <nav aria-label="Workflow-Schritte" className="bg-white dark:bg-gray-800 rounded px-2 py-1.5 border border-gray-200 dark:border-gray-700">
