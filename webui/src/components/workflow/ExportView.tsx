  ...
  return (
    <div className="space-y-3">
      <div className="text-center">
        <h2 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Bundle exportieren</h2>
        <p className="text-xs text-gray-500">Proof-Bundle als ZIP speichern</p>
      </div>
          ...
          {!isComplete ? (
            ...
            <>
              <div className="flex items-center justify-center mb-2">
                ...
                <span className="ml-1 text-xs font-semibold text-green-600">Export erfolgreich!</span>
              </div>
              <div className="space-y-1 text-left bg-gray-50 dark:bg-gray-900 rounded p-2 text-[10px]">
                <div className="flex justify-between"><span className="text-gray-500">Größe:</span><span className="font-medium">{formatFileSize(exportResult.size_bytes)}</span></div>
                ...
                <div className="flex justify-between"><span className="text-gray-500">Dateien:</span><span>{exportResult.files.length}</span></div>
              ...
              <div className="flex gap-2 mt-2">
                <button onClick={handleExport} className="flex-1 px-2 py-1 text-[10px] text-gray-600 bg-gray-100 rounded hover:bg-gray-200">Erneut</button>
                <button onClick={reset} className="flex-1 px-2 py-1 text-[10px] text-blue-600 bg-blue-50 rounded hover:bg-blue-100">Neues Projekt</button>
              </div>
            </>
          )}
      ...
      <div className="flex justify-between max-w-sm mx-auto pt-1">
        ...
        {isComplete && (
          <div className="text-green-600 flex items-center text-xs">
            ...
            <span className="ml-1 font-medium">Fertig!</span>
          </div>
        )}
      </div>
    </div>
